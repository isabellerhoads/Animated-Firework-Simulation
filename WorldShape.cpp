...
//}
//
//void WorldShape::loadMesh(const string& meshName)
//{
//	// Load geometry
...
//}
//
//void WorldShape::draw(const shared_ptr<Program> prog) const
//{
...
//}
//
//float WorldShape::get_minimum_y() {
//	vector<float> vals;
//	for (int j = 1; j < posBuf.size(); j += 3) {
//		vals.push_back(posBuf.at(j));
//	}
